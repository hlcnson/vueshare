...
// uri: địa chỉ của graphql server (backend) để kết nối front-end với back-end,
// graphql server chính là nơi để truy vấn và ghi dữ liệu.
// Phần http://localhost:4000 sẽ được thay bằng tên miền của website khi triển khai ứng dụng.
const defaultClient = new ApolloClient({
    uri: 'http://localhost:4000/graphql'
})

// Khởi tạo Vue Apollo với đối tượng cấu hình có thuộc tính apollo client đã tạo
...
new Vue({
    ...
    // Cách cấu hình với thuộc tính provide như vậy đã lỗi thời. Có thể viết lại theo
    // cách mới như sau:
    // apolloProvider,
